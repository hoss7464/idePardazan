                ...
                <div className="relative p-6 flex-auto text-right">
                  {
                    selectedItemData.map((item, index) => (
                      <div className='flex row justify-between border-solid border-2	border-zinc-300	m-3'>
                        <p>گزاره:        <span className='bg-zinc-200'>{item.label}</span></p>
                        <p>وزن:       <span className='bg-zinc-200'>{item.value}</span></p>
                      </div>
