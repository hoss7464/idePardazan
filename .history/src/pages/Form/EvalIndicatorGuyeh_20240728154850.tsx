...
const EvalIndicatorGuyeh: React.FC = () => {
  ...
  const { errorGuyeh, dataIndicatorGuyeh, getEvalIndicatorGuyehListData } = EvalIndicatorGuyehShow();
  ...
  const handleShowInfo = async (id: number) => {
    await getEvalIndicatorGuyehListData(id);
  };
