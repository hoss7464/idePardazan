...
const EvalIndicatorGuyeh: React.FC = () => {
  ...
  const [selectedItemModal, setselectedItem] = useState<any>(null);
  ...
  const handleUpdateApi = async () => {
    ...
    if (newTitle !== "" && fields) {
      await updateEvalItem(selectedItemData.id,newTitle, location.state, fields);
                                ...
                                <tr key={index} className="border-zinc-200">
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 border-zinc-200">
                                    ...
                                    <button
                                      ...
                                      type="button"
                                      onClick={() => { setupdateModal(true); setselectedItem(field) }}
