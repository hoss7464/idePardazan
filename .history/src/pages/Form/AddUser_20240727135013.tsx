...
const AddUser: React.FC = () => {
  ...
  return (
    <>
      ...
      {errorAdd && (
        <div
          className="flex fixed z-50 justify-between items-center p-4 mb-4 text-sm text-white rounded-lg bg-red-500	 dark:bg-gray-800 dark:text-red-400"
          role="alert"
        >
          <div>
            <img src='/src/components/Icon/error.svg' />
      ...
      <Breadcrumb pageName="افزودن کاربر" />
            ...
            <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
              <div className="w-full xl:w-1/2">
                <div>
                  ...
                  <div className="relative flex justify-between flex-row-reverse z-10 bg-white dark:bg-form-input">
