...
const OrganizationLevel: React.FC = () => {
  ...
  return (
    <>
      ...
      {errorupdate || errorAdd || errordelet && (
        <div
            ...
            <div className="relative my-6 mx-auto w-1/3">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto text-right">
                  ...
                  <input
                    type="text"
                    placeholder="نام سطح سازمانی"
                    value={newOLName}
                    onChange={(e) => setnewOLName(e.target.value)}
                ...
                <div className="-m-1.5 overflow-x-auto">
                  <div className="p-1.5 min-w-full inline-block align-middle">
                    <div className="overflow-hidden">
                      ...
                      {errorOL && (
                        <div className="mt-4 text-red-500">{errorOL}</div>
                      )}
                    </div>
                  </div>
                </div>
