...
const AdminPeriod: React.FC = () => {
  ...
  return (
    <>
      {emptyError && (
        <div
          className="flex fixed justify-between items-center p-4 mb-4 text-sm text-white rounded-lg bg-red-400 dark:bg-gray-800 dark:text-red-400 upperLayer"
          role="alert"
        >
          <div>
      ...
      {addModal && (
        ...
        {emptyError && (
        <div
          className="flex z-50 fixed justify-between items-center p-4 mb-4 text-sm text-white rounded-lg bg-red-400 dark:bg-gray-800 dark:text-red-400 upperLayer"
          role="alert"
        >
          <div>
            <img src='/src/components/Icon/error.svg' />
