...
const AdminPeriod: React.FC = () => {
  ...
  const [newPeriodAddName, setnewPeriodAddName] = useState('');
  ...
  const [startAdd_date, setStartAdd_date] = useState('');
  const [startAdd_date_persian, setstartAdd_date_persian] = useState('');
  const [endAdd_date, setendAdd_date] = useState('');
  const [endAdd_date_persian, setendAdd_date_persian] = useState('');
  ...
  useEffect(() => {
    if (error || errorAdd || errordelete || errorupdate || emptyError) {
  ...
  }, [error, errorAdd, errordelete, errorupdate, emptyError]);
  ...
  return (
    <>
      ...
      {showErrorTimer && error && <Error myError={"در دریافت لیست دوره ها!"} />}

      {showErrorTimer && (errorAdd || errordelete || errorupdate) && <Error myError={"عملیات موفقیت آمیز نبود!"} />}
            ...
            <div className="relative my-6 mx-auto w-1/3">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative px-6 py-3 flex-auto text-right">
                  <CustomInput
                    label="نام دوره"
                    value={newPeriodAddName}
                    onChange={setnewPeriodAddName}
                ...
                <div className="relative px-6 py-3 flex-auto text-right">
                  ...
                  <div className="flex relative z-50 flex-row-reverse text-center justify-center items-center setting-widthDP">
                    <DatePicker
                      value={startAdd_date_persian}
                      dateFormat="yyyy-MM-dd"
                      onChange={(selectedDate) => handleDateChange(selectedDate, setStartAdd_date, setstartAdd_date_persian)}
                    />
                  </div>
                </div>
                <div className="relative px-6 py-3 flex-auto text-right">
                  ...
                  <div className="flex relative z-50 flex-row-reverse text-center justify-center items-center setting-widthDP">
                    <DatePicker
                      value={endAdd_date_persian}
                      dateFormat="yyyy-MM-dd"
                      onChange={(selectedDate) => handleDateChange(selectedDate, setendAdd_date, setendAdd_date_persian)}
                    />
                  </div>
                </div>
                <div className="flex items-center justify-end p-6 border-t border-solid border-zinc-200 rounded-b">
                  ...
                  <CustomButton
                    onClick={() =>
                      handleAdd(newPeriodAddName, startAdd_date, endAdd_date)
                    }
                                            ...
                                            <div className="relative px-6 py-3 flex-auto text-right">
                                              ...
                                              <div className="flex relative z-50 flex-row-reverse text-center justify-center items-center setting-widthDP">
                                                ...
                                                <DatePicker
                                                  ...
                                                  dateFormat="yyyy-MM-dd"
                                                  onChange={(selectedDate) => handleDateChange(selectedDate, setStart_date, setstart_date_persian)}
                                                />
                                              </div>
                                            </div>
                                            <div className="relative px-6 py-3 flex-auto text-right">
                                              ...
                                              <div className="flex relative z-50 flex-row-reverse text-center justify-center items-center setting-widthDP">
                                                ...
                                                />
                                                  ...
                                                  value={end_date_persian}
                                                  dateFormat="yyyy-MM-dd"
                                                  onChange={(selectedDate) => handleDateChange(selectedDate, setEnd_date, setstart_date_persian)}
                                                />
                                              </div>
                                            </div>
                                            <div className="flex items-center justify-end p-6 border-t border-solid border-zinc-200 rounded-b">
