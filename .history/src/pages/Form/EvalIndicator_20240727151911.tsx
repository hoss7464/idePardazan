...
const EvalIndicator: React.FC = () => {
  ...
  return (
    <>
      ...
      {errorCreateIndicator && <EvalError myError={errorUpdateIndicator} />}
      {errordelete && <EvalError myError={errorUpdateIndicator} />}
      {errorParam && <EvalError myError={errorUpdateIndicator} />}
