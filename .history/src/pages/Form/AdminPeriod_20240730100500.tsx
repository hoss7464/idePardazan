...
const AdminPeriod: React.FC = () => {
  ...
  const handleStartDateChange = (selectedDate: any, set: (value: string) => void, setPersian: (value: string) => void) => {
  ...
  return (
    ...
    onChange={(selectedDate) => handleStartDateChange(selectedDate, setStartAdd_date, setstartAdd_date_persian)}
/>
                  </div>
                </div>
                <div className="relative px-6 py-3 flex-auto text-right">
