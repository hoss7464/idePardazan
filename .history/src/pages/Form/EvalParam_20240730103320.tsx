...
const EvalParam: React.FC = () => {
  ...
  useEffect(() => {
    ...
    else setnewParamTitle("")
  }, [selectedParam]);

  useEffect(() => {
    if (errorUpdateParam || errorParam || emptyError) {
  ...
  }, [errorUpdateParam, errorParam, emptyError]);
  ...
  return (
    <>
      {showErrorTimer && errorParam && (
        <Error myError={"در دریافت لیست! "} />
      )}

      {showErrorTimer && errorUpdateParam && (
                                        ...
                                        <div className="relative my-6 mx-auto  w-1/3">
                                          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                            ...
                                            <div className="flex items-center justify-end p-6 border-t border-solid border-zinc-200 rounded-b">
                                              ...
                                              <CustomButton
                                                onClick={() => handleDelete('' + selectedParam.id,)}
