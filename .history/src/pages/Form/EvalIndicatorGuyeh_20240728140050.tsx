...
const EvalIndicatorGuyeh: React.FC = () => {
  ...
  return (
    <>
      ...
      <p className="mb-6">{dataIndicatorGuyeh[0]?.title}</p>
              ...
              <div className=" border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex flex-col w-full mt-4 mb-4">
                  <input
                    ...
                    className="w-full  mr-6 rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    placeholder="عنوان"
                  />
                </div>
