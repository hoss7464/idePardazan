...
const UpdateUser: React.FC = () => {
  ...
  useEffect(() => {
    if (error || errorShow || errorOL || errorOU||showErrorType||showError||errorAdd) {
  ...
  }, [error, errorShow, errorOL, errorOU,showErrorType,showError,errorAdd]);
