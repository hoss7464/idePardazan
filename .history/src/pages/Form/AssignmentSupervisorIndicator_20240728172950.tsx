...
const AssignmentSupervisorIndicator: React.FC = () => {
  ...
  const [selectedEmployee, setSelectedEmployee] = useState<object[] | null>();
            ...
            <div className="w-full xl:w-1/2">
              <div>
                ...
                <SearchableSelect
                  ...
                  onChange={(option) => {
                    handleChange('select1')(option); // فراخوانی handleChange با گزینه جدید
                    setSelectedPeriod(option); // مقدار انتخاب شده را به setSelectedPeriod منتقل کنید
                  }}
                  myPlaceHolder="دوره"
            ...
            <div className="w-full xl:w-1/2">
              <div>
                ...
                <SearchableSelect
                  ...
                  onChange={() => { handleChange('select2'); setSelectedSupervisor(selectedOptions.select2) }}
