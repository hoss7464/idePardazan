                            ...
                            <>
                              {dataIndicatorGuyeh?.map((field, index) => (
                                <tr key={index} className="border-zinc-200">
                                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 border-zinc-200  w-1/4">
                                    {field.title}
                                  </td>

                                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200 border-zinc-200 flex align-center justify-beetween w-3/4">
                                    <button
