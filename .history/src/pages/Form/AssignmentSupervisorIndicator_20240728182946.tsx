...
const AssignmentSupervisorIndicator: React.FC = () => {
  ...
  const handleAdd = async () => {
    await AssignmentIndicatorStore(selectedPeriod.value, selectedSupervisor.value, employementList, selectedIndicator.value, weight);
  };
