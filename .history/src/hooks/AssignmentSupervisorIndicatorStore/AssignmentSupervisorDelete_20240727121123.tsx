...
function AssignmentSupervieorDelete() {
  ...
  const getAdminSADeletebasedPeriod = async (period_id: number) => {
    try {
      ...
      const response = await fetch(
        `https://mqtt-broker.ir/api/admin/supervisor-assignment/period/${period_id}/delete`,
        {
          method: 'Delete',
          headers: headers,
        },
  ...
  const getAdminSADeletebasedPeriodSupervisor = async (
    ...
    try {
      ...
      const response = await fetch(
        `https://mqtt-broker.ir/api/admin/supervisor-assignment/supervisor/${supervisor_id}/period/${period_id}/delete`,
        {
          method: 'Delete',
          headers: headers,
        },
  ...
  const getAdminSADeletebasedPeriodSupervisorEmployee = async (
    ...
    try {
      ...
      const response = await fetch(
        `https://mqtt-broker.ir/api/admin/supervisor-assignment/employee/${employee_id}/supervisor/${supervisor_id}/period/${period_id}/delete`,
        {
          method: 'Delete',
          headers: headers,
        },
