...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-scroll bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}
      scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-black dark:scrollbar-track-boxdark`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/addAdmin"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('addAdmin') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pr-6 text-sm	">
                          <li>
                            <NavLink
                              to="/Member/company"
                              className={({ isActive }) =>
